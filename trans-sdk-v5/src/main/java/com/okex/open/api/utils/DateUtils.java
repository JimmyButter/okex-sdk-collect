...
//        System.out.println("————————时间戳："+nowStr);
    ...
    /**
     * 相比当前花费了多少时间
     * 按UnixTimeType返回的单位有秒，分，小时，天
     * @param historyTime
     * @param type
     * @return
     */
    public static long unixCurrentTimeSpan(long historyTime, UnixTimeType type) {
        return (System.currentTimeMillis() - historyTime)/type.v();
    }
